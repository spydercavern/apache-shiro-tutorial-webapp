...
<body>
  ...
  <p>
    <shiro:hasRole name="Captains">Captains is Logged In<br/></shiro:hasRole>
    <shiro:hasRole name="Officers">Bad Guys is Logged In<br/></shiro:hasRole>
    <shiro:hasRole name="Enlisted">Enlisted is Logged In<br/></shiro:hasRole>
  </p>
